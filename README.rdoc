...
The Google Places API documentation states:
...
Please be aware that the <tt>reference</tt> field in spot details mey differ from the <tt>reference</tt> used to retrieve that spot.
