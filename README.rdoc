...
* To get these values: You can use <tt>@client.spot(place_id)</tt>. This returns more information of the spot by making an extra call.
* To get a collection of these detailed spots: You can use <tt>@client.detailed_spots(lat, lng)</tt>. This makes an extra call for each spot and returns a collection of the detailed spots.
...
=== Retrieving detailed spots
This makes an extra call for each spot and returns a collection of the detailed spots.

  @client.detailed_spots(-33.8670522, 151.1957362)
