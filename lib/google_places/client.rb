module GooglePlaces
  ...
  class Client
    ...
    # Search for detailed Spots at the provided location.
    # Note) This makes an extra call for each spot for more information(its complete address, phone number, user rating, reviews).
    #
    # @return [Array<Spot>]
    # @param [String,Integer] lat the latitude for the search
    # @param [String,Integer] lng the longitude for the search
    ...
    # @see http://spreadsheets.google.com/pub?key=p9pdwsai2hDMsLkXsoM05KQ&gid=1 List of supported languages
    # @see https://developers.google.com/maps/documentation/places/supported_types List of supported types
    # @see https://developers.google.com/places/web-service/details Place Details
    def detailed_spots(lat, lng, options = {})
